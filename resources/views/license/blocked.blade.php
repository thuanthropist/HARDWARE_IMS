...
<head>
    ...
    <title>License Required · {{ setting('business.name', 'Hardware IMS') }}</title>
    ...
    <div class="w-full max-w-md px-4">
        ...
        <div class="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
            <div class="mb-4 flex items-center gap-3">
                ...
                <div>
                    <h2 class="text-base font-semibold text-slate-900">License Required</h2>
                    <p class="text-sm text-slate-500">This installation doesn't have an active license yet.</p>
                </div>
            </div>

            @can('manage-license')
                <p class="mb-4 text-sm text-slate-600">
                    Enter this installation's license key to activate it.
                </p>
            ...
            @else
                <p class="mb-4 text-sm text-slate-600">
                    Ask an administrator to activate a license key to restore access. If you believe this is a mistake, contact support below.
                </p>
            @endcan
